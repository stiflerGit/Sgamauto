...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='',
  syntax='proto2',
  serialized_pb=_b('\n\x0f\x64riversdb.proto\"\x17\n\x03\x41\x43K\x12\x10\n\x08_result_\x18\x01 \x01(\t\"Z\n\x04Test\x12\x0f\n\x07_targa_\x18\x01 \x02(\t\x12\x13\n\x0b_timestamp_\x18\x02 \x02(\x04\x12\x11\n\t_alc_lvl_\x18\x03 \x02(\r\x12\x19\n\x08_driver_\x18\x04 \x02(\x0b\x32\x07.Driver\"\xac\x01\n\x06\x44river\x12\x1e\n\x07_known_\x18\x01 \x02(\x0e\x32\r.Driver.Known\x12\x0f\n\x07_photo_\x18\x02 \x02(\x0c\x12\x0c\n\x04_cf_\x18\x03 \x01(\t\x12\x13\n\x0b_firstname_\x18\x04 \x01(\t\x12\x12\n\n_lastname_\x18\x05 \x01(\t\x12\r\n\x05_age_\x18\x06 \x01(\r\x12\x11\n\t_lic_age_\x18\x07 \x01(\r\"\x18\n\x05Known\x12\x07\n\x03YES\x10\x00\x12\x06\n\x02NO\x10\x01\"3\n\x06\x43onfig\x12\x12\n\n_data_dev_\x18\x01 \x02(\x0c\x12\x15\n\r_face_recogn_\x18\x02 \x02(\x0c\"\x18\n\x05Targa\x12\x0f\n\x07_targa_\x18\x01 \x02(\t\")\n\tFileChunk\x12\x0e\n\x06offset\x18\x01 \x01(\x03\x12\x0c\n\x04\x64\x61ta\x18\x02 \x01(\x0c\x32\x46\n\tInsurance\x12\x1f\n\nInitDevice\x12\x06.Targa\x1a\x07.Config\"\x00\x12\x18\n\x07\x41nalize\x12\x05.Test\x1a\x04.ACK\"\x00')
)
...
_DRIVER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='_photo_', full_name='Driver._photo_', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='_cf_', full_name='Driver._cf_', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='_firstname_', full_name='Driver._firstname_', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='_lastname_', full_name='Driver._lastname_', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='_age_', full_name='Driver._age_', index=5,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='_lic_age_', full_name='Driver._lic_age_', index=6,
...
_CONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='_data_dev_', full_name='Config._data_dev_', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='_face_recogn_', full_name='Config._face_recogn_', index=1,
      number=2, type=12, cpp_type=9, label=2,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TARGA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='_targa_', full_name='Targa._targa_', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FILECHUNK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='offset', full_name='FileChunk.offset', index=0,
...
DESCRIPTOR.message_types_by_name['Targa'] = _TARGA
...
Targa = _reflection.GeneratedProtocolMessageType('Targa', (_message.Message,), dict(
  DESCRIPTOR = _TARGA,
  __module__ = 'driversdb_pb2'
  # @@protoc_insertion_point(class_scope:Targa)
  ))
_sym_db.RegisterMessage(Targa)
...
_INSURANCE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='InitDevice',
    full_name='Insurance.InitDevice',
    index=0,
